package it.mesis.tmm.interceptor;

import it.mesis.tmm.model.Centritrasf;
import it.mesis.tmm.service.UtentiService;
...
public class Trasfusionale implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request,
    	...
    	if (request.getRequestURI().equalsIgnoreCase("/tmm/boot/") || request.getRequestURI().equalsIgnoreCase("/tmm/logout"))
		...
		if (session == null || session.getAttribute("trasfusionale") == null) {
			...
			if (ct != null) {
	             ...
	             *   response.sendRedirect("/tmm/boot/");
	             *   return false;
	             */
			}
		}
