...
@Component
public class RoleToUserProfileConverter implements Converter<Object, UserProfileEntity>{
	 ...
	 */
	public UserProfileEntity convert(Object element) {
		Integer id = Integer.parseInt((String)element);
		UserProfileEntity profile = userProfileService.findById(id);
