package it.mesis.util.model.jq;
...
public class DataTable<T extends Serializable> {
	...
	Integer recordsTotal;	//Total records, before filtering (i.e. the total number of records in the database)
	...
	public DataTable(Integer recordsTotal, Integer recordsFiltered, List<T> data, Integer draw) {
		super();
